...
#
# @param nginx_app_protect_timeoutstartsec Parameter from role
# @param nginx_app_protect_timeoutstopsec Parameter from role
...
class paw_nginxinc_nginx_core::nginx_app_protect (
  ...
  par { 'paw_nginxinc_nginx_core::nginx_app_protect-main':
    ensure        => present,
    playbook      => "${settings::vardir}/lib/puppet_x/ansible_modules/paw_nginxinc_nginx_core/roles/nginx_app_protect/playbook.yml",
    playbook_vars => {
