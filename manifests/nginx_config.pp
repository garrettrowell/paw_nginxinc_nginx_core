...
#
# @param module Parameter from role
# @param connection Parameter from role
# @param address Parameter from role
# @param signature Parameter from role
# @param allow Parameter from role
# @param deny Parameter from role
# @param file Parameter from role
# @param directive Parameter from role
# @param header Parameter from role
# @param command Parameter from role
# @param condition Parameter from role
# @param certificate Parameter from role
# @param key Parameter from role
# @param ansible_managed Parameter from role
# @param nginx_config_start Parameter from role
# @param nginx_config_debug_output Parameter from role
# @param nginx_config_cleanup Parameter from role
# @param nginx_config_selinux Parameter from role
# @param nginx_config_selinux_enforcing Parameter from role
# @param nginx_config_html_demo_template_enable Parameter from role
# @param nginx_config_html_demo_template Parameter from role
# @param nginx_config_main_template_enable Parameter from role
# @param nginx_config_main_template Parameter from role
# @param nginx_config_http_template_enable Parameter from role
# @param nginx_config_http_template Parameter from role
# @param nginx_config_status_enable Parameter from role
# @param nginx_config_status_template_file Parameter from role
# @param nginx_config_status_file_location Parameter from role
# @param nginx_config_status_backup Parameter from role
# @param nginx_config_status_port Parameter from role
# @param nginx_config_status_access_log Parameter from role
# @param nginx_config_status_allow Parameter from role
# @param nginx_config_status_deny Parameter from role
# @param nginx_config_rest_api_enable Parameter from role
# @param nginx_config_rest_api_template_file Parameter from role
# @param nginx_config_rest_api_file_location Parameter from role
# @param nginx_config_rest_api_backup Parameter from role
# @param nginx_config_rest_api_port Parameter from role
# @param nginx_config_rest_api_write Parameter from role
# @param nginx_config_rest_api_access_log Parameter from role
# @param nginx_config_rest_api_allow Parameter from role
# @param nginx_config_rest_api_deny Parameter from role
# @param nginx_config_rest_api_dashboard Parameter from role
# @param nginx_config_rest_api_dashboard_allow Parameter from role
# @param nginx_config_rest_api_dashboard_deny Parameter from role
# @param nginx_config_stream_template_enable Parameter from role
# @param nginx_config_stream_template Parameter from role
# @param nginx_config_upload_enable Parameter from role
# @param nginx_config_upload Parameter from role
# @param nginx_config_upload_html_enable Parameter from role
# @param nginx_config_upload_html Parameter from role
# @param nginx_config_upload_ssl_enable Parameter from role
# @param nginx_config_upload_ssl_crt Parameter from role
# @param nginx_config_upload_ssl_key Parameter from role
class paw_nginxinc_nginx_core::nginx_config (
  ...
  par { 'paw_nginxinc_nginx_core::nginx_config-main':
    ensure        => present,
    playbook      => "${settings::vardir}/lib/puppet_x/ansible_modules/paw_nginxinc_nginx_core/roles/nginx_config/playbook.yml",
    playbook_vars => {
      'module'                                 => $module,
